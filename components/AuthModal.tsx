      ...
      <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-8 w-full max-w-sm mx-4 shadow-2xl" onClick={e => e.stopPropagation()}>
        ...
        <div className="space-y-2.5">
          ...
          <button onClick={signInWithApple} type="button"
            className="w-full flex items-center justify-center gap-3 bg-black text-white font-medium rounded-lg py-2.5 text-sm border border-zinc-700 hover:bg-zinc-900 transition-colors">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
